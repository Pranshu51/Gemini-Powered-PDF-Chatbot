...
def get_text_chunks(text):
    """
    Splits the raw text into smaller chunks for processing.
    """
...
def get_conversational_chain():
    """
    Creates and returns the conversational chain for Q&A.
    """
    prompt_template = """
...
def user_input(user_question):
    """
    Processes the user's question, performs a similarity search, and gets a response from the LLM.
    """
    embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001")
    
    # Load the vector store with the security flag. This is the fix for the previous error.
